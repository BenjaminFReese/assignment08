...
The average silhouette width indicates an optimal number of clusters is 2. The gap statistic indicates that the optimal number of clusters is 5. The within sum squares indicates that the optimal number of 4 clusters.
